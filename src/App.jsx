      ...
      <div className="hero-content">
        ...
        <div className="hero-left">
          ...
          <div className="store-buttons">
            <a href="https://playpaca-cloud.web.app" className="store-btn store-btn-web" target="_blank" rel="noopener noreferrer">
            ...
            <div className="store-btn store-btn-ios store-btn-disabled">
              ...
              <div className="store-btn-text">
                <span className="store-btn-sub">In review</span>
                <span className="store-btn-title">App Store</span>
              </div>
            </div>
            <div className="store-btn store-btn-android store-btn-disabled">
              <svg className="store-btn-icon" viewBox="0 0 24 24" fill="currentColor">
